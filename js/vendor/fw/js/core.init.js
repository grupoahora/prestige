...
function airsupply_init_actions() {
  ...
  if (
    AIRSUPPLY_STORAGE["vc_edit_mode"] &&
    jQuery(".vc_empty-placeholder").length == 0 &&
    AIRSUPPLY_STORAGE["theme_init_counter"]++ < 30
  ) {
...
function airsupply_ready_actions() {
  ...
  jQuery(".widget_calendar").on(
    ...
    function (e) {
      ...
      jQuery
        .post(AIRSUPPLY_STORAGE["ajax_url"], {
  ...
  if (jQuery("ul#menu_side").length > 0) {
    ...
    airsupply_show_current_menu_item(
  ...
  if (jQuery(".header_mobile").length > 0) {
    ...
    jQuery("#menu_mobile a").on("click", function (e) {
      e.preventDefault();
  ...
  if (
    AIRSUPPLY_STORAGE["menu_hover"] == "slide_line" ||
    AIRSUPPLY_STORAGE["menu_hover"] == "slide_box"
  ) {
    setTimeout(function () {
      "use strict";
  ...
  if (
    AIRSUPPLY_STORAGE["toc_menu"] != "hide" &&
    AIRSUPPLY_STORAGE["toc_menu"] != "no"
  ) {
  ...
  jQuery("#viewmore_link").on("click", function (e) {
    "use strict";
    if (
      !AIRSUPPLY_STORAGE["viewmore_busy"] &&
  ...
  jQuery(".bookmarks_add").on("click", function (e) {
    ...
    if (!exists) {
      var message_popup = airsupply_message_dialog(
        '<label for="bookmark_title">' +
          AIRSUPPLY_STORAGE["strings"]["bookmark_title"] +
          '</label><br><input type="text" id="bookmark_title" name="bookmark_title" value="' +
          title +
          '">',
        AIRSUPPLY_STORAGE["strings"]["bookmark_add"],
        null,
        function (btn, popup) {
          "use strict";
          if (btn != 1) return;
          ...
          jQuery(".bookmarks_list").append(
            '<li><a href="' +
              ...
              AIRSUPPLY_STORAGE["strings"]["bookmark_del"] +
              '"></span></a></li>'
          );
          jQuery.cookie("airsupply_bookmarks", JSON.stringify(list), {
            expires: 365,
            path: "/",
          });
          setTimeout(function () {
            airsupply_message_success(
              AIRSUPPLY_STORAGE["strings"]["bookmark_added"],
              AIRSUPPLY_STORAGE["strings"]["bookmark_add"]
            );
          }, AIRSUPPLY_STORAGE["message_timeout"] / 4);
        }
      );
    } else airsupply_message_warning(AIRSUPPLY_STORAGE["strings"]["bookmark_exists"], AIRSUPPLY_STORAGE["strings"]["bookmark_add"]);
    e.preventDefault();
    return false;
  });
  ...
  if (window.airsupply_init_hidden_elements)
    airsupply_init_hidden_elements(jQuery("body").eq(0));
} //end ready
...
function airsupply_scroll_actions() {
  ...
  if (AIRSUPPLY_STORAGE["top_panel_height"] < 1) {
    AIRSUPPLY_STORAGE["top_panel_height"] = Math.max(
      0,
    ...
    if (jQuery(".top_panel_below .slider_wrap").length > 0) {
      ...
      if (slider_height < 10) {
        slider_height = jQuery(".slider_wrap").hasClass(".slider_fullscreen")
          ...
          : AIRSUPPLY_STORAGE["slider_height"];
      }
    }
    if (
      scroll_offset <=
      slider_height + AIRSUPPLY_STORAGE["top_panel_height"]
    ) {
      ...
      if (
        ...
        jQuery(".top_panel_fixed_wrap").height(
          AIRSUPPLY_STORAGE["top_panel_height"]
        );
  ...
  if (jQuery(".sidebar_outer").length > 0) {
    ...
    if (
      ...
      AIRSUPPLY_STORAGE["side_panel_height"] + 100
    ) {
  ...
  jQuery("#toc .toc_item").each(function () {
    ...
    if (
      ...
      scroll_offset + AIRSUPPLY_STORAGE["top_panel_height"] < off_next
    )
...
function airsupply_resize_video_background() {
  ...
  if (
    AIRSUPPLY_STORAGE["media_elements_enabled"] &&
          ...
          onBeforeShow: function (ul) {
            ...
            if (AIRSUPPLY_STORAGE["css_animation"]) {
              jQuery(this).removeClass(
                "animated fast " + AIRSUPPLY_STORAGE["menu_animation_out"]
              );
              jQuery(this).addClass(
                "animated fast " + AIRSUPPLY_STORAGE["menu_animation_in"]
              );
            }
          },
...
function airsupply_build_page_toc() {
  ...
  if (
    toc_count >
    (AIRSUPPLY_STORAGE["toc_menu_home"] ? 1 : 0) +
      (AIRSUPPLY_STORAGE["toc_menu_top"] ? 1 : 0)
  ) {
    if (jQuery("#toc").length > 0) jQuery("#toc .toc_inner").html(toc);
    else
      jQuery("body").append(
        '<div id="toc" class="toc_' +
          AIRSUPPLY_STORAGE["toc_menu"] +
          '"><div class="toc_inner">' +
          toc +
          "</div></div>"
      );
...
function airsupply_init_isotope() {
  ...
  jQuery(".isotope_wrap:not(.inited)").each(function () {
    "use strict";
    all_images_complete =
      all_images_complete && airsupply_check_images_complete(jQuery(this));
  });
  // Wait for images loading
  if (
    !all_images_complete &&
    AIRSUPPLY_STORAGE["isotope_init_counter"]++ < 30
  ) {
...
function airsupply_init_appended_isotope(posts_container, filters) {
  ...
  if (
    !airsupply_check_images_complete(posts_container) &&
    AIRSUPPLY_STORAGE["isotope_init_counter"]++ < 30
  ) {
    setTimeout(function () {
      airsupply_init_appended_isotope(posts_container, filters);
    }, 200);
    return;
  }
  // Add filters
...
function airsupply_init_post_formats() {
  ...
  // Call theme specific action (if exists)
  if (window.airsupply_theme_init_post_formats)
    airsupply_theme_init_post_formats();
          ...
          .done(function (response) {
            ...
            if (rez.error === "") {
              ...
              airsupply_message_warning(
                AIRSUPPLY_STORAGE["strings"]["error_like"]
              );
            }
          });
        e.preventDefault();
...
function airsupply_init_media_elements(cont) {
  if (
    ...
    if (window.mejs) {
      ...
      setTimeout(function () {
        airsupply_init_media_elements(cont);
      }, 400);
  }
}
...
function airsupply_show_system_message() {
  if (
    AIRSUPPLY_STORAGE["system_message"] &&
    AIRSUPPLY_STORAGE["system_message"]["message"]
  ) {
    if (AIRSUPPLY_STORAGE["system_message"]["status"] == "success")
      airsupply_message_success(
        AIRSUPPLY_STORAGE["system_message"]["message"],
        AIRSUPPLY_STORAGE["system_message"]["header"]
      );
      ...
      AIRSUPPLY_STORAGE["system_message"]["status"] == "error" ||
      AIRSUPPLY_STORAGE["system_message"]["status"] == "warning"
    )
      airsupply_message_warning(
        AIRSUPPLY_STORAGE["system_message"]["message"],
        AIRSUPPLY_STORAGE["system_message"]["header"]
...
function airsupply_toggle_popup(popup) {
  if (popup.css("display") != "none") airsupply_hide_popup(popup);
  else airsupply_show_popup(popup);
}
...
function airsupply_show_popup(popup) {
  if (popup.css("display") == "none") {
    if (false && AIRSUPPLY_STORAGE["css_animation"])
      popup
        .show()
        .removeClass("animated fast " + AIRSUPPLY_STORAGE["menu_animation_out"])
        .addClass("animated fast " + AIRSUPPLY_STORAGE["menu_animation_in"]);
...
function airsupply_hide_popup(popup) {
  if (popup.css("display") != "none") {
    if (false && AIRSUPPLY_STORAGE["css_animation"])
      popup
        .removeClass("animated fast " + AIRSUPPLY_STORAGE["menu_animation_in"])
        .addClass("animated fast " + AIRSUPPLY_STORAGE["menu_animation_out"])
        .delay(500)
        .hide();
    else popup.fadeOut();
  }
...
function airsupply_comments_validate(form) {
    ...
    rules: [
      {
        ...
        min_length: {
          value: 1,
          message: AIRSUPPLY_STORAGE["strings"]["text_empty"],
        },
        max_length: {
          value: AIRSUPPLY_STORAGE["comments_maxlength"],
          message: AIRSUPPLY_STORAGE["strings"]["text_long"],
        },
      },
    ],
  };
  if (form.find('.comments_author input[aria-required="true"]').length > 0) {
    rules.rules.push({
      ...
      min_length: {
        value: 1,
        message: AIRSUPPLY_STORAGE["strings"]["name_empty"],
      },
      max_length: {
        value: 60,
        message: AIRSUPPLY_STORAGE["strings"]["name_long"],
      },
    });
  }
  if (form.find('.comments_email input[aria-required="true"]').length > 0) {
    rules.rules.push({
      ...
      min_length: {
        value: 7,
        message: AIRSUPPLY_STORAGE["strings"]["email_empty"],
      },
      max_length: {
        value: 60,
        message: AIRSUPPLY_STORAGE["strings"]["email_long"],
      },
      mask: {
        value: AIRSUPPLY_STORAGE["email_mask"],
        message: AIRSUPPLY_STORAGE["strings"]["email_not_valid"],
      },
    });
  }
    ...
    rules: [
      {
        ...
        min_length: {
          value: 1,
          message: AIRSUPPLY_STORAGE["strings"]["login_empty"],
        },
        max_length: {
          value: 60,
          message: AIRSUPPLY_STORAGE["strings"]["login_long"],
        },
      },
      {
        field: "pwd",
        min_length: {
          value: 4,
          message: AIRSUPPLY_STORAGE["strings"]["password_empty"],
        },
        max_length: {
          value: 30,
          message: AIRSUPPLY_STORAGE["strings"]["password_long"],
        },
      },
    ],
  });
      ...
      .done(function (response) {
        ...
        if (rez.error === "") {
          result_box
            ...
            .html(AIRSUPPLY_STORAGE["strings"]["login_success"]);
          setTimeout(function () {
            location.reload();
          }, 3000);
        } else {
          result_box
            ...
            .html(
              AIRSUPPLY_STORAGE["strings"]["login_failed"] + "<br>" + rez.error
            );
        }
    ...
    rules: [
      {
        ...
        state: {
          value: "checked",
          message: AIRSUPPLY_STORAGE["strings"]["not_agree"],
        },
      },
      {
      ...
      },
      {
        ...
        equal_to: {
          ...
          message: AIRSUPPLY_STORAGE["strings"]["password_not_equal"],
        },
      },
    ],
  });
    ...
    jQuery
      ...
      .done(function (response) {
        ...
        if (rez.error === "") {
          result_box
            .addClass("sc_infobox sc_infobox_style_success")
            .html(AIRSUPPLY_STORAGE["strings"]["registration_success"]);
          setTimeout(function () {
          ...
          result_box
            .addClass("sc_infobox sc_infobox_style_error")
            .html(
              AIRSUPPLY_STORAGE["strings"]["registration_failed"] +
                " " +
                rez.error
            );
        }
